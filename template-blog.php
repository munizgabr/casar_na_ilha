...
<div class="center bg-white  grid grid-cols-1 md:grid-cols-[auto_auto] gap-4 mt-[80px] sm:mt-[90px] md:mt-[98px]">
    <?php
    ...
    ?>
            <div class="p-4 bg-[#176B87] rounded-md shadow-[0_3px_10px_rgb(0,0,0,0.2)] my-4 text-center md:text-start">
                ...
                <p class="text-[#fff] grid md:grid-cols-[auto_auto] place-items-center items-end gap-4"><?php echo esc_html($post_content); ?><a href="<?php the_permalink(); ?>" class="btn-ver-todos text-[#fff] border-4 border-[#fff] hover:text-[#176B87] hover:bg-[#fff]">Ver tudo</a></p>
            </div>
    <?php
        endwhile;
